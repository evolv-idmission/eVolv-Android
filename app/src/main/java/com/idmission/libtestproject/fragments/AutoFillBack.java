...
public class AutoFillBack extends Fragment implements ImageProcessingResponseListener {
   ...
   // private static final String[] TITLE_IMAGE = {"None", "Title Image 1"};
    ...
    private EditText lightThresholdEdtTxt, maxFocusThresholdEdtTxt, minFocusThresholdEdtTxt, glarePercentageEdtTxt,
            ...
            maxMRZRetryCountEdtTxt, maxMRZBarcodeRetryCountEdtTxt;
    private static final String IMAGE_LIGHT_THRESHOLD_FRONT = "IMAGE_LIGHT_THRESHOLD_FRONT", IMAGE_MAX_FOCUS_THRESHOLD_FRONT = "IMAGE_MAX_FOCUS_THRESHOLD_FRONT", IMAGE_MIN_FOCUS_THRESHOLD_FRONT = "IMAGE_MIN_FOCUS_THRESHOLD_FRONT",
            ...
            MRZ_SCAN_COUNT_MAX = "MRZ_SCAN_COUNT_MAX", BARCODE_SCAN_COUNT_MAX = "BARCODE_SCAN_COUNT_MAX", MRZ_BARCODE_SCAN_COUNT_MAX = "MRZ_BARCODE_SCAN_COUNT_MAX";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.auto_fill_layout, container, false);
        ...
        maxMRZBarcodeRetryCountEdtTxt = (EditText) view.findViewById(R.id.mrz_barcode_retry_count_edttext);
    ...
    private void setSavedValue() {
        ...
        maxMRZRetryCountEdtTxt.setText(PreferenceUtils.getPreference(getActivity(), MRZ_SCAN_COUNT_MAX, "" + ImageProcessingSDK.dMRZRetryCount));
        maxMRZBarcodeRetryCountEdtTxt.setText(PreferenceUtils.getPreference(getActivity(), MRZ_BARCODE_SCAN_COUNT_MAX, "" + ImageProcessingSDK.dMRZBarcodeRetryCount));
    ...
    private void resetValue() {
        ...
        maxMRZRetryCountEdtTxt.setText("" + ImageProcessingSDK.dMRZRetryCount);
        maxMRZBarcodeRetryCountEdtTxt.setText("" + ImageProcessingSDK.dMRZBarcodeRetryCount);
            ...
            public void onClick(View view) {
              ...
              //  String textFontType = ((Pair)spinnerTextFontType.getSelectedItem()).second.toString();
               // String textFontStyle = ((Pair)spinnerTextFontStyle.getSelectedItem()).second.toString();
                ...
                String mrzBarcodeRetryCount = maxMRZBarcodeRetryCountEdtTxt.getText().toString().trim();
               ...
               // PreferenceUtils.setPreference(getActivity(), TEXT_FONT_TYPE_FRONT, textFontType);
                ...
                PreferenceUtils.setPreference(getActivity(), MRZ_SCAN_COUNT_MAX, mrzRetryCount);
                PreferenceUtils.setPreference(getActivity(), MRZ_BARCODE_SCAN_COUNT_MAX, mrzBarcodeRetryCount);
...
//                    fragmentManager.beginTransaction().replace(R.id.flContent, processFlow).addToBackStack(null).commit();
    ...
    private void captureCameraAPICall() {
        ImageProcessingSDK.getInstance().setImageProcessingResponseListener(AutoFillBack.this);
        if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ...
            String mrzRetryCount = PreferenceUtils.getPreference(getActivity(), MRZ_SCAN_COUNT_MAX, "" + ImageProcessingSDK.dMRZRetryCount);
            String barcodeRetryCount = PreferenceUtils.getPreference(getActivity(), BARCODE_SCAN_COUNT_MAX, "" + ImageProcessingSDK.dBarcodeRetryCount);
            String mrzBarcodeRetryCount = PreferenceUtils.getPreference(getActivity(), MRZ_BARCODE_SCAN_COUNT_MAX, "" + ImageProcessingSDK.dMRZBarcodeRetryCount);
...
//                            showInstruction, 0);
            ...
            try {
               ...
               // }
                commonFunctioObject.put(UIConfigConstants.ID_SIDE, ImageType.BACK.toString());
                commonFunctioObject.put(UIConfigConstants.ID_MRZ_RETRY_COUNT, mrzRetryCount);
                commonFunctioObject.put(UIConfigConstants.ID_BARCODE_RETRY_COUNT, barcodeRetryCount);
                commonFunctioObject.put(UIConfigConstants.ID_MRZ_BARCODE_RETRY_COUNT, mrzBarcodeRetryCount);
...
//                ImageProcessingSDK.getInstance().autoCapture(getActivity(), ImageType.FRONT, commonFunctioObject, null, null);
                ImageProcessingSDK.getInstance().autoFill(getActivity(), commonFunctioObject, eVolvApp.getAdditonalData());
    ...
    public void onAutoFillResultAvailable(Map<String, String> resultMap, Response response) {
        Log.d("SDK", "CALLBACK:::: onAutoFillResultAvailable resultmap: " + resultMap.toString());
        ...
        if (resultMap != null && resultMap.size() > 0) {
            ...
            if (resultMap.containsKey("RESULT")) {
                String jsonData = resultMap.get("RESULT");
...
//                            value = StringEscapeUtils.escapeXml11(value);
                           // StringEscapeUtils.unescapeJava(value).trim();
                         //   hm.put(key, value.trim());
                            hm.put(key,  StringEscapeUtils.unescapeXml(value).trim());
                        }
...
//    }
    ...
    private void showBarcodeData(HashMap<String, String> resultData, boolean showBarcodeData) {
