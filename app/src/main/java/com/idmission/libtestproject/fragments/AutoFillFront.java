...
public class AutoFillFront extends Fragment implements ImageProcessingResponseListener {
...
//                    fragmentManager.beginTransaction().replace(R.id.flContent, processFlow).addToBackStack(null).commit();
    ...
    private void captureCameraAPICall() {
        ImageProcessingSDK.getInstance().setImageProcessingResponseListener(AutoFillFront.this);
...
//                            showInstruction, 0);
            ...
            try {
               ...
               // if (isBarcodeEnable) {
                ...
                commonFunctioObject.put(UIConfigConstants.ID_SIDE, ImageType.FRONT.toString());
