...
public class SelfieProcessedFace extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        Bitmap bitmapFace = BitmapUtils.getBitmapFromFile(eVolvApp.getBaseDirectoryPath() + Constants.PROCESSED_FACE_IMAGE);
