...
public class SelfieOverrideProcessedFace extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        Bitmap bitmapFace = BitmapUtils.getBitmapFromFile(eVolvApp.getBaseDirectoryPath() + Constants.PROCESSED_FACE_IMAGE_OVERRIDE);
        imageViewSelfieImage.setImageBitmap(bitmapFace);
       // textViewSelfie.setText(FaceImageType.PROCESSED_FACE.toString());
        textViewSelfie.setText(getString(R.string.processed_face));
