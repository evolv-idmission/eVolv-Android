...
public final class IDDetails extends Fragment implements ImageProcessingResponseListener {
    ...
    private RelativeLayout relativeLayoutState, relativeLayoutState_secondary;
...
//                eVolvApp.setSecondaryIdType(idTypeSecondary);
                ...
                ImageProcessingSDK.getInstance().setImageProcessingResponseListener(IDDetails.this);
