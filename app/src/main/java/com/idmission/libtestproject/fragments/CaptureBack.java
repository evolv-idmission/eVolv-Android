...
public class CaptureBack extends Fragment implements ImageProcessingResponseListener {
   ...
   // private static final String[] ID_CAPTURE_TITLE_ALIGNMENT = {"Top", "Center", "Bottom"};
    ...
    private EditText lightThresholdEdtTxt, maxFocusThresholdEdtTxt, minFocusThresholdEdtTxt, glarePercentageEdtTxt,
            ...
            textLabelColorEdtTxt, textLabelAlphaEdtTxt, retryButtonBorderAlphaEdtTxt, confirmButtonStyleAlphaEdtTxt, retryButtonBorderColorEdtTxt, confirmButtonStyleEdtTxt, maxBarcodeScanEdtTxt,
    ...
    private void setSavedValue() {
        ...
        maxBarcodeScanEdtTxt.setText(PreferenceUtils.getPreference(getActivity(), ID_BARCODE_SCAN_MAX_BACK, "" + ImageProcessingSDK.maxBarcodeScan));
        maxMRZRetryCountEdtTxt.setText(PreferenceUtils.getPreference(getActivity(), MRZ_SCAN_COUNT_MAX_BACK, "" + ImageProcessingSDK.dIDCaptureMRZRetryCount));
       ...
       // spinnerHeaderTextFontStyle.setSelection(Arrays.asList(TEXT_FONT_STYLE_ARRAY).indexOf(headerTextFontStyle));
        ...
        boolean idBarcodeEnable = PreferenceUtils.getPreference(getActivity(), ID_BARCODE_ENABLE, false);
        if (idBarcodeEnable) {
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // PreferenceUtils.setPreference(getActivity(), TEXT_FONT_TYPE_BACK, textFontType);
                ...
                PreferenceUtils.setPreference(getActivity(), ID_BARCODE_ENABLE, isBarcodeEnable);
                PreferenceUtils.setPreference(getActivity(), ID_BARCODE_SCAN_MAX_BACK, maxBarcodeScan);
                ...
                PreferenceUtils.setPreference(getActivity(), MRZ_SCAN_COUNT_MAX_BACK, mrzRetryCount);
...
//                    fragmentManager.beginTransaction().replace(R.id.flContent, processFlow).addToBackStack(null).commit();
    ...
    private void captureCameraAPICall() {
        ImageProcessingSDK.getInstance().setImageProcessingResponseListener(CaptureBack.this);
        if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ...
            String idCaptureBorderType = PreferenceUtils.getPreference(getActivity(), ID_CAPTURE_BORDER_TYPE_BACK, ""+ ImageProcessingSDK.dIdCaptureBorder);
            boolean isBarcodeEnable = PreferenceUtils.getPreference(getActivity(), ID_BARCODE_ENABLE, false);
            String maxBarcodeScan = PreferenceUtils.getPreference(getActivity(), ID_BARCODE_SCAN_MAX_BACK, "" + ImageProcessingSDK.maxBarcodeScan);
            String mrzRetryCount = PreferenceUtils.getPreference(getActivity(), MRZ_SCAN_COUNT_MAX_BACK, "" + ImageProcessingSDK.dMRZRetryCount);
...
//                commonFunctioObject.put(UIConfigurationParameters.ID_CAPTURE_BORDER, idCaptureBorderType);
                ...
                ImageProcessingSDK.getInstance().autoCapture(getActivity(), ImageType.BACK, commonFunctioObject, null, null);
    ...
    public void onResume() {
        ...
        Bitmap bitmap = BitmapUtils.getBitmapFromFile(eVolvApp.getBaseDirectoryPath() + Constants.BACK_IMAGE);
        setImage(bitmap);
        setSavedValue();
    }
                ...
                if (null != resultMap) {
                    if (resultMap.containsKey(ImageType.BACK.toString())) {
                        ...
                        if (!StringUtil.isEmpty(imageBase64)) {
                            ...
                            BitmapUtils.writeBitmapToFilepath(eVolvApp.getBaseDirectoryPath() + Constants.BACK_IMAGE, bitmap);
