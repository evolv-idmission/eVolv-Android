...
import com.idmission.libtestproject.adapter.SelfiePageAdapter;
...
public class SelfieCapture extends Fragment implements ImageProcessingResponseListener {
   ...
   // private static final String[] FACE_TITILE_IMAGE_ALIGNMENT = {"Top", "Bottom"};
    ...
    private static final String FACE_GLARE_THRESHOLD = "FACE_GLARE_THRESHOLD", FACE_LIGHT_THRESHOLD = "FACE_LIGHT_THRESHOLD", FACE_FOCUS_THRESHOLD = "FACE_FOCUS_THRESHOLD", FACE_DETECTION_THRESHOLD = "FACE_DETECTION_THRESHOLD",
            SATURATION_VALUE = "SATURATION_VALUE", FACE_OUTLINE_COLOR = "FACE_OUTLINE_COLOR", DETECTED_FACE_OUTLINE_COLOR = "DETECTED_FACE_OUTLINE_COLOR", OUTSIDE_FACE_OUTLINE_COLOR = "OUTSIDE_FACE_OUTLINE_COLOR",
            ...
            ENABLE_FRONT_CAMERA = "ENABLE_FRONT_CAMERA", ENABLE_TOGGLE_CAMERA = "ENABLE_TOGGLE_CAMERA", ENABLE_PASSIVE_FACE_DETECTION = "ENABLE_PASSIVE_FACE_DETECTION", ENABLE_CROPPING = "ENABLE_CROPPING", ENABLE_DO_NOT_CAPTURE = "ENABLE_DO_NOT_CAPTURE", UPLOAD_FACE_DATA = "UPLOAD_FACE_DATA", ENABLE_BGR = "ENABLE_BGR", SHOW_PREVIEW_SCREEN = "SHOW_PREVIEW_SCREEN", SHOW_INSTRUCTION_SCREEN = "SHOW_INSTRUCTION_SCREEN",
            ...
            PASSIVE_FACE_DETECTION_THRESHOLD = "PASSIVE_FACE_DETECTION_THRESHOLD",EYES_OPEN_THRESHOLD = "EYES_OPEN_THRESHOLD", SPOOFFACE_DETECTION_THRESHOLD = "SPOOFFACE_DETECTION_THRESHOLD";
    ...
    private EditText faceLightThresholdEdtTxt, faceGlareThresholdEdtTxt, faceFocusThresholdEdtTxt, faceDetectionThresholdEdtTxt, saturationValueEdtTxt,
            ...
            eyesOpenThresholEditText, livelinessThresholdEditText;
    private TextView faceModelNameTxtView;

    private SwitchCompat launchFrontCameraCheckBox, toggleCameraCheckBox, passiveFaceDetectionCheckBox, enable_cropping_toggle, enable_donotcapture_toggle, upload_facedata_toggle, rgb_bgr_toggle, showPreviewScreenCheckBox, showInstructionFaceDetect;
    ...
    private SelfiePageAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.selfie_capture_layout, container, false);
        ...
        eyesOpenThresholEditText = (EditText) view.findViewById(R.id.eyeOpenThreshold_ET);
        livelinessThresholdEditText = (EditText) view.findViewById(R.id.livelinessThreshold_ET);
        saturationValueEdtTxt = (EditText) view.findViewById(R.id.saturation_value);
        ...
        passiveFaceDetectionCheckBox = (SwitchCompat) view.findViewById(R.id.passiveFaceDetectionCheckBox);
        enable_cropping_toggle = (SwitchCompat) view.findViewById(R.id.enable_cropping_toggle);
        enable_donotcapture_toggle = (SwitchCompat) view.findViewById(R.id.enable_do_not_capture);
        upload_facedata_toggle = (SwitchCompat) view.findViewById(R.id.upload_facedata_toggle);
        rgb_bgr_toggle = (SwitchCompat) view.findViewById(R.id.rgb_bgr_toggle);
        ...
        faceModelNameTxtView = (TextView) view.findViewById(R.id.face_model_name_txtview);
        faceModelNameTxtView.setText("Face model: " + ImageProcessingSDK.getFaceModelName());
       ...
       // spinnerFaceContours.setAdapter(new ArrayAdapter<String>(getContext(), android.R.layout.simple_dropdown_item_1line, FACE_CONTOURS));
        ...
        LinearLayout cropping_donotcapture_ll = (LinearLayout) view.findViewById(R.id.cropping_donotcapture_ll);
        LinearLayout upload_face_data_ll = (LinearLayout) view.findViewById(R.id.upload_face_data_ll);
        LinearLayout threshold_ll = (LinearLayout) view.findViewById(R.id.threshold_ll);
        if (ImageProcessingSDK.isEnableDebug()) {
            cropping_donotcapture_ll.setVisibility(View.VISIBLE);
            threshold_ll.setVisibility(View.VISIBLE);
            upload_face_data_ll.setVisibility(View.VISIBLE);
        } else {
            cropping_donotcapture_ll.setVisibility(View.GONE);
            threshold_ll.setVisibility(View.GONE);
            upload_face_data_ll.setVisibility(View.GONE);

//            PreferenceUtils.setPreference(getActivity(), UPLOAD_FACE_DATA, ImageProcessingSDK.dUploadFaceData);
           // upload_facedata_toggle.setChecked(PreferenceUtils.getPreference(getActivity(), UPLOAD_FACE_DATA, ImageProcessingSDK.dUploadFaceData));
        }
        return view;
    }
    ...
    public void onResume() {
        ...
        Bitmap bitmapFace = BitmapUtils.getBitmapFromFile(eVolvApp.getBaseDirectoryPath() + Constants.FACE_IMAGE);
        Bitmap bitmapOval = BitmapUtils.getBitmapFromFile(eVolvApp.getBaseDirectoryPath() + Constants.OVAL_FACE_IMAGE);
        Bitmap bitmapProcessed = BitmapUtils.getBitmapFromFile(eVolvApp.getBaseDirectoryPath() + Constants.PROCESSED_FACE_IMAGE);
...
//        faceDetectionThresholdEdtTxt.setText(PreferenceUtils.getPreference(getActivity(), FACE_DETECTION_THRESHOLD, "" + ImageProcessingSDK.dFaceDetectionThreshold));
        faceDetectionThresholdEdtTxt.setText(PreferenceUtils.getPreference(getActivity(), PASSIVE_FACE_DETECTION_THRESHOLD, "" + ImageProcessingSDK.dPassiveFaceDetectionThreshold));
        eyesOpenThresholEditText.setText(PreferenceUtils.getPreference(getActivity(), EYES_OPEN_THRESHOLD, "" + ImageProcessingSDK.dPassive_EyesOpenThreshold));
        livelinessThresholdEditText.setText(PreferenceUtils.getPreference(getActivity(), SPOOFFACE_DETECTION_THRESHOLD, "" + ImageProcessingSDK.dPassive_SpoofDetectionThreshold));

        saturationValueEdtTxt.setText(PreferenceUtils.getPreference(getActivity(), SATURATION_VALUE, "" + ImageProcessingSDK.dSaturationValue));
        ...
        passiveFaceDetectionCheckBox.setChecked(PreferenceUtils.getPreference(getActivity(), ENABLE_PASSIVE_FACE_DETECTION, ImageProcessingSDK.dFacePassiveFaceDetection));
        enable_cropping_toggle.setChecked(PreferenceUtils.getPreference(getActivity(), ENABLE_CROPPING, ImageProcessingSDK.dFaceEnableCropping));
        enable_donotcapture_toggle.setChecked(PreferenceUtils.getPreference(getActivity(), ENABLE_DO_NOT_CAPTURE, ImageProcessingSDK.dFaceEnableCropping));
        upload_facedata_toggle.setChecked(PreferenceUtils.getPreference(getActivity(), UPLOAD_FACE_DATA, ImageProcessingSDK.dUploadFaceData));
        rgb_bgr_toggle.setChecked(PreferenceUtils.getPreference(getActivity(), ENABLE_BGR, ImageProcessingSDK.dEnableBGR));
...
//        faceDetectionThresholdEdtTxt.setText("" + ImageProcessingSDK.dFaceDetectionThreshold);
        faceDetectionThresholdEdtTxt.setText("" + ImageProcessingSDK.dPassiveFaceDetectionThreshold);
        eyesOpenThresholEditText.setText("" + ImageProcessingSDK.dPassive_EyesOpenThreshold);
        livelinessThresholdEditText.setText("" + ImageProcessingSDK.dPassive_SpoofDetectionThreshold);
        saturationValueEdtTxt.setText("" + ImageProcessingSDK.dSaturationValue);
        ...
        passiveFaceDetectionCheckBox.setChecked(ImageProcessingSDK.dFacePassiveFaceDetection);
        enable_cropping_toggle.setChecked(ImageProcessingSDK.dFaceEnableCropping);
        enable_donotcapture_toggle.setChecked(ImageProcessingSDK.dFaceEnableCropping);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String eyesOpenThreshold = eyesOpenThresholEditText.getText().toString().trim();
                String livelinessThreshold = livelinessThresholdEditText.getText().toString().trim();
                String saturation = saturationValueEdtTxt.getText().toString().trim();
...
//                String headerTextFontStyle = ((Pair)spinnerHeaderTextFontStyle.getSelectedItem()).second.toString();
                ...
                PreferenceUtils.setPreference(getActivity(), PASSIVE_FACE_DETECTION_THRESHOLD, detectionThreshold);
                PreferenceUtils.setPreference(getActivity(), EYES_OPEN_THRESHOLD, eyesOpenThreshold);
                PreferenceUtils.setPreference(getActivity(), SPOOFFACE_DETECTION_THRESHOLD, livelinessThreshold);
                PreferenceUtils.setPreference(getActivity(), SATURATION_VALUE, saturation);
                ...
                PreferenceUtils.setPreference(getActivity(), ENABLE_PASSIVE_FACE_DETECTION, passiveFaceDetectionCheckBox.isChecked());
                PreferenceUtils.setPreference(getActivity(), ENABLE_CROPPING, enable_cropping_toggle.isChecked());
                PreferenceUtils.setPreference(getActivity(), ENABLE_DO_NOT_CAPTURE, enable_donotcapture_toggle.isChecked());
                PreferenceUtils.setPreference(getActivity(), UPLOAD_FACE_DATA, upload_facedata_toggle.isChecked());
                PreferenceUtils.setPreference(getActivity(), ENABLE_BGR, rgb_bgr_toggle.isChecked());
...
//                faceTitleAlignment = ((Pair)spinnerTitleAlignment.getSelectedItem()).second.toString();
//                faceHintMsgAlignment = ((Pair)spinnerHintMsgAlignment.getSelectedItem()).second.toString();
//                faceHintIconAlignment = ((Pair)spinnerHintIconAlignment.getSelectedItem()).second.toString();
//                faceTitleImageAlignment = ((Pair)spinnerTitleImageAlignment.getSelectedItem()).second.toString();
...
//                    fragmentManager.beginTransaction().replace(R.id.flContent, processFlow).addToBackStack(null).commit();
    ...
    private void selfieCaptureAPICall() {
        ImageProcessingSDK.getInstance().setImageProcessingResponseListener(SelfieCapture.this);
...
//            String detectionThreshold = PreferenceUtils.getPreference(getActivity(), FACE_DETECTION_THRESHOLD, "" + ImageProcessingSDK.dFaceDetectionThreshold);
            String detectionThreshold = PreferenceUtils.getPreference(getActivity(), PASSIVE_FACE_DETECTION_THRESHOLD, "" + ImageProcessingSDK.dPassiveFaceDetectionThreshold);
            String eyesOpenThreshold = PreferenceUtils.getPreference(getActivity(), EYES_OPEN_THRESHOLD, "" + ImageProcessingSDK.dPassive_EyesOpenThreshold);
            String livelinessThreshold = PreferenceUtils.getPreference(getActivity(), SPOOFFACE_DETECTION_THRESHOLD, "" + ImageProcessingSDK.dPassive_SpoofDetectionThreshold);

            String saturation = PreferenceUtils.getPreference(getActivity(), SATURATION_VALUE, "" + ImageProcessingSDK.dSaturationValue);
            ...
            boolean passiveDetect = PreferenceUtils.getPreference(getActivity(), ENABLE_PASSIVE_FACE_DETECTION, ImageProcessingSDK.dFacePassiveFaceDetection);
            boolean enableCropping = PreferenceUtils.getPreference(getActivity(), ENABLE_CROPPING, ImageProcessingSDK.dFaceEnableCropping);
            boolean enableDoNotCapture = PreferenceUtils.getPreference(getActivity(), ENABLE_DO_NOT_CAPTURE, ImageProcessingSDK.dFaceEnableCropping);
            boolean uploadFaceDta = PreferenceUtils.getPreference(getActivity(), UPLOAD_FACE_DATA, ImageProcessingSDK.dUploadFaceData);
            boolean enableBGR = PreferenceUtils.getPreference(getActivity(), ENABLE_BGR, ImageProcessingSDK.dEnableBGR);
            ...
            int detectionThresholdVal = (!StringUtil.isEmpty(detectionThreshold) ? Integer.parseInt(detectionThreshold) : ImageProcessingSDK.dPassiveFaceDetectionThreshold);
//            float detectionThresholdVal = (!StringUtil.isEmpty(detectionThreshold) ? Float.parseFloat(detectionThreshold) : ImageProcessingSDK.dPassiveFaceDetectionThreshold);
            int eyesOpenThresholdVal = (!StringUtil.isEmpty(eyesOpenThreshold) ? Integer.parseInt(eyesOpenThreshold) : ImageProcessingSDK.dPassive_EyesOpenThreshold);
            int livelinessThresholdVal = (!StringUtil.isEmpty(livelinessThreshold) ? Integer.parseInt(livelinessThreshold) : ImageProcessingSDK.dPassive_SpoofDetectionThreshold);

            int saturationValue = (!StringUtil.isEmpty(saturation) ? Integer.parseInt(saturation) : ImageProcessingSDK.dSaturationValue);
...
//                            titleBitmap, instructionScreen, R.mipmap.face_combine_instruction, toggleCamera);
            ...
            try {
                ...
                commonUIObject.put(UIConfigurationParameters.FD_EYE_OPEN_THRESHOLD, eyesOpenThresholdVal+"");
                commonUIObject.put(UIConfigurationParameters.FD_SPOOF_DETECTION_THRESHOLD, livelinessThresholdVal+"");
                commonUIObject.put(UIConfigurationParameters.FD_SATURATION_VALUE, saturationValue+"");
              ...
              //  commonUIObject.put(UIConfigurationParameters.FD_SHOW_INSTRUCTION_SCREEN, instructionScreen == true ? "Y" : "N");
                ...
                commonUIObject.put(UIConfigurationParameters.FD_ENABLE_CROPPING, enableCropping == true ? "Y" : "N");
                commonUIObject.put(UIConfigurationParameters.FD_ENABLE_DONOTCAPTURE, enableDoNotCapture == true ? "Y" : "N");
                commonUIObject.put(UIConfigurationParameters.FD_UPLOAD_FACE_DATA, uploadFaceDta == true ? "Y" : "N");
                commonUIObject.put(UIConfigurationParameters.FD_ENABLE_BGR, enableBGR == true ? "Y" : "N");
                commonUIObject.put(UIConfigurationParameters.FD_PASSIVE_FACE_DETECTION, passiveDetect == true ? "Y" : "N");
...
//
//               // commonUIObject.put(UIConfigurationParameters.FD_SHOW_CUSTOM_UI, "Y");
//                commonUIObject.put(UIConfigurationParameters.FD_FACE_OUTLINE_IMAGE_ID, "" + R.drawable.fd_outline);
//                commonUIObject.put(UIConfigurationParameters.FD_OUTSIDE_FACE_OUTLINE_IMAGE_ID, "" + R.drawable.fd_background);
//                commonUIObject.put(UIConfigurationParameters.FD_FACE_OUTLINE_PROGRESS_IMAGES, progress);
//                commonUIObject.put(UIConfigurationParameters.FD_FACE_OUTLINE_PROGRESS_IMAGES_DELAY, "500");
//                commonUIObject.put(UIConfigurationParameters.FD_FACE_TURN_ARROW_LIST, turnArrow);
               ...
               // ImageProcessingSDK.getInstance().detectFace(getActivity(), commonUIObject);
                ImageProcessingSDK.getInstance().detectFace(getActivity(), commonUIObject, eVolvApp.getAdditonalData());
    ...
    public void onFaceDetectionResultAvailable(Map<String, String> resultMap, Response response) {
        ...
        if (null != response) {
            ...
            } else if (response.getStatusCode() == ResponseStatusCode.LIVE_FACE_NOT_DETECTED.getStatusCode()) {

                FileUtils.deleteFile(eVolvApp.getBaseDirectoryPath() + Constants.FACE_IMAGE);
                FileUtils.deleteFile(eVolvApp.getBaseDirectoryPath() + Constants.PROCESSED_FACE_IMAGE);
                FileUtils.deleteFile(eVolvApp.getBaseDirectoryPath() + Constants.OVAL_FACE_IMAGE);

                defaultImage.setImageBitmap(null);
                textViewDefault.setText(getString(R.string.live_face_not_detected));
                ...
                if (null != resultMap) {
                    if (resultMap.containsKey(FaceImageType.FACE.toString())) {
                        ...
                        if (!StringUtil.isEmpty(faceImageBase64)) {
                            ...
                            File basePath = new File(eVolvApp.getBaseDirectoryPath());
                            basePath.mkdirs();
                            BitmapUtils.writeBitmapToFilepath(eVolvApp.getBaseDirectoryPath() + Constants.FACE_IMAGE, bitmap);
                            isCapture = false;
                    ...
                    if (resultMap.containsKey(FaceImageType.PROCESSED_FACE.toString())) {
                        ...
                        if (!StringUtil.isEmpty(processedFaceImageBase64)) {
                            ...
                            BitmapUtils.writeBitmapToFilepath(eVolvApp.getBaseDirectoryPath() + Constants.PROCESSED_FACE_IMAGE, bitmap);
                        }
                    }
                    if (resultMap.containsKey(FaceImageType.OVAL_FACE.toString())) {
                        ...
                        if (!StringUtil.isEmpty(ovalFaceImageBase64)) {
                            ...
                            BitmapUtils.writeBitmapToFilepath(eVolvApp.getBaseDirectoryPath() + Constants.OVAL_FACE_IMAGE, bitmap);
                        }
                    }
                }
            }
...
//    }
    ...
    private void setUpView() {
        adapter = new SelfiePageAdapter(getActivity(), getChildFragmentManager());
